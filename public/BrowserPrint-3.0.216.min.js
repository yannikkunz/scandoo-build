...
var BrowserPrint = (function () {
    ...
    e.Device = function (a) {
        ...
        this.send = function (d, a, f) {
            ...
            g && (void 0 !== m && (void 0 === a && (a = m.sendFinishedCallback), void 0 === f && (f = m.sendErrorCallback)), c(g, a, f), g.send(JSON.stringify({ device: { name: this.name, uid: this.uid, connection: this.connection, deviceType: this.deviceType, version: this.version, provider: this.provider, manufacturer: this.manufacturer }, data: d })));
        };
        this.sendUrl = function (d, a, f, e) {
            var g = b("POST", l + "write");
            g && (c(m, g, a, f), (d = { device: { name: this.name, uid: this.uid, connection: this.connection, deviceType: this.deviceType, version: this.version, provider: this.provider, manufacturer: this.manufacturer }, url: d }), null != e && void 0 != e && (d.options = e), g.send(JSON.stringify(d)));
        };
        ...
        this.read = function (d, a) {
            var f = b("POST", l + "read");
            f && (void 0 !== m && (void 0 === d && (d = m.readFinishedCallback), void 0 === a && (a = m.readErrorCallback)), c(f, d, a), f.send(JSON.stringify({ device: { name: this.name, uid: this.uid, connection: this.connection, deviceType: this.deviceType, version: this.version, provider: this.provider, manufacturer: this.manufacturer } })));
        };
